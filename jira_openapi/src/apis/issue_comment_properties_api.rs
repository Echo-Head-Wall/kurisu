...
pub async fn delete_comment_property(configuration: &configuration::Configuration, comment_id: &str, property_key: &str) -> Result<(), Error<DeleteCommentPropertyError>> {
    ...
    let uri_str = format!("{}/rest/api/3/comment/{commentId}/properties/{propertyKey}", configuration.base_path, commentId=crate::apis::urlencode(p_comment_id), propertyKey=crate::apis::urlencode(p_property_key));
...
pub async fn get_comment_property_keys(configuration: &configuration::Configuration, comment_id: &str) -> Result<models::PropertyKeys, Error<GetCommentPropertyKeysError>> {
    ...
    let uri_str = format!("{}/rest/api/3/comment/{commentId}/properties", configuration.base_path, commentId=crate::apis::urlencode(p_comment_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
