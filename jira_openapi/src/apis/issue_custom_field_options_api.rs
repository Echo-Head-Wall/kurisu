...
pub async fn create_custom_field_option(configuration: &configuration::Configuration, field_id: &str, context_id: i64, bulk_custom_field_option_create_request: models::BulkCustomFieldOptionCreateRequest) -> Result<models::CustomFieldCreatedContextOptionsList, Error<CreateCustomFieldOptionError>> {
    ...
    let uri_str = format!("{}/rest/api/3/field/{fieldId}/context/{contextId}/option", configuration.base_path, fieldId=crate::apis::urlencode(p_field_id), contextId=p_context_id);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CustomFieldCreatedContextOptionsList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CustomFieldCreatedContextOptionsList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_custom_field_option(configuration: &configuration::Configuration, field_id: &str, context_id: i64, option_id: i64) -> Result<(), Error<DeleteCustomFieldOptionError>> {
    ...
    let uri_str = format!("{}/rest/api/3/field/{fieldId}/context/{contextId}/option/{optionId}", configuration.base_path, fieldId=crate::apis::urlencode(p_field_id), contextId=p_context_id, optionId=p_option_id);
...
pub async fn get_custom_field_option(configuration: &configuration::Configuration, id: &str) -> Result<models::CustomFieldOption, Error<GetCustomFieldOptionError>> {
    ...
    let uri_str = format!("{}/rest/api/3/customFieldOption/{id}", configuration.base_path, id=crate::apis::urlencode(p_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CustomFieldOption`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CustomFieldOption`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_options_for_context(configuration: &configuration::Configuration, field_id: &str, context_id: i64, option_id: Option<i64>, only_options: Option<bool>, start_at: Option<i64>, max_results: Option<i32>) -> Result<models::PageBeanCustomFieldContextOption, Error<GetOptionsForContextError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PageBeanCustomFieldContextOption`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PageBeanCustomFieldContextOption`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn reorder_custom_field_options(configuration: &configuration::Configuration, field_id: &str, context_id: i64, order_of_custom_field_options: models::OrderOfCustomFieldOptions) -> Result<serde_json::Value, Error<ReorderCustomFieldOptionsError>> {
    ...
    let uri_str = format!("{}/rest/api/3/field/{fieldId}/context/{contextId}/option/move", configuration.base_path, fieldId=crate::apis::urlencode(p_field_id), contextId=p_context_id);
...
pub async fn replace_custom_field_option(configuration: &configuration::Configuration, field_id: &str, option_id: i64, context_id: i64, replace_with: Option<i64>, jql: Option<&str>) -> Result<(), Error<ReplaceCustomFieldOptionError>> {
    ...
    let uri_str = format!("{}/rest/api/3/field/{fieldId}/context/{contextId}/option/{optionId}/issue", configuration.base_path, fieldId=crate::apis::urlencode(p_field_id), optionId=p_option_id, contextId=p_context_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ReplaceCustomFieldOptionError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn update_custom_field_option(configuration: &configuration::Configuration, field_id: &str, context_id: i64, bulk_custom_field_option_update_request: models::BulkCustomFieldOptionUpdateRequest) -> Result<models::CustomFieldUpdatedContextOptionsList, Error<UpdateCustomFieldOptionError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::CustomFieldUpdatedContextOptionsList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::CustomFieldUpdatedContextOptionsList`")))),
        }
    } else {
        let content = resp.text().await?;
