...
pub async fn add_issue_types_to_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, issue_type_ids: models::IssueTypeIds) -> Result<serde_json::Value, Error<AddIssueTypesToIssueTypeSchemeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype", configuration.base_path, issueTypeSchemeId=p_issue_type_scheme_id);
...
pub async fn assign_issue_type_scheme_to_project(configuration: &configuration::Configuration, issue_type_scheme_project_association: models::IssueTypeSchemeProjectAssociation) -> Result<serde_json::Value, Error<AssignIssueTypeSchemeToProjectError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/project", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
...
pub async fn create_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_details: models::IssueTypeSchemeDetails) -> Result<models::IssueTypeSchemeId, Error<CreateIssueTypeSchemeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::IssueTypeSchemeId`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::IssueTypeSchemeId`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn delete_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64) -> Result<serde_json::Value, Error<DeleteIssueTypeSchemeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/{issueTypeSchemeId}", configuration.base_path, issueTypeSchemeId=p_issue_type_scheme_id);
...
pub async fn get_all_issue_type_schemes(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, id: Option<Vec<i64>>, order_by: Option<&str>, expand: Option<&str>, query_string: Option<&str>) -> Result<models::PageBeanIssueTypeScheme, Error<GetAllIssueTypeSchemesError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PageBeanIssueTypeScheme`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PageBeanIssueTypeScheme`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_issue_type_scheme_for_projects(configuration: &configuration::Configuration, project_id: Vec<i64>, start_at: Option<i64>, max_results: Option<i32>) -> Result<models::PageBeanIssueTypeSchemeProjects, Error<GetIssueTypeSchemeForProjectsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PageBeanIssueTypeSchemeProjects`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PageBeanIssueTypeSchemeProjects`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_issue_type_schemes_mapping(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, issue_type_scheme_id: Option<Vec<i64>>) -> Result<models::PageBeanIssueTypeSchemeMapping, Error<GetIssueTypeSchemesMappingError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/mapping", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PageBeanIssueTypeSchemeMapping`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PageBeanIssueTypeSchemeMapping`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn remove_issue_type_from_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, issue_type_id: i64) -> Result<serde_json::Value, Error<RemoveIssueTypeFromIssueTypeSchemeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype/{issueTypeId}", configuration.base_path, issueTypeSchemeId=p_issue_type_scheme_id, issueTypeId=p_issue_type_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn reorder_issue_types_in_issue_type_scheme(configuration: &configuration::Configuration, issue_type_scheme_id: i64, order_of_issue_types: models::OrderOfIssueTypes) -> Result<serde_json::Value, Error<ReorderIssueTypesInIssueTypeSchemeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/issuetypescheme/{issueTypeSchemeId}/issuetype/move", configuration.base_path, issueTypeSchemeId=p_issue_type_scheme_id);
    let mut req_builder = configuration.client.request(reqwest::Method::PUT, &uri_str);
