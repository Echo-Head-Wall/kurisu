...
pub async fn delete_avatar(configuration: &configuration::Configuration, r#type: &str, owning_object_id: &str, id: i64) -> Result<(), Error<DeleteAvatarError>> {
    ...
    let uri_str = format!("{}/rest/api/3/universal_avatar/type/{type}/owner/{owningObjectId}/avatar/{id}", configuration.base_path, type=crate::apis::urlencode(p_type), owningObjectId=crate::apis::urlencode(p_owning_object_id), id=p_id);
...
pub async fn get_all_system_avatars(configuration: &configuration::Configuration, r#type: &str) -> Result<models::SystemAvatars, Error<GetAllSystemAvatarsError>> {
    ...
    let uri_str = format!("{}/rest/api/3/avatar/{type}/system", configuration.base_path, type=crate::apis::urlencode(p_type));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SystemAvatars`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SystemAvatars`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_avatar_image_by_id(configuration: &configuration::Configuration, r#type: &str, id: i64, size: Option<&str>, format: Option<&str>) -> Result<(), Error<GetAvatarImageByIdError>> {
    ...
    let uri_str = format!("{}/rest/api/3/universal_avatar/view/type/{type}/avatar/{id}", configuration.base_path, type=crate::apis::urlencode(p_type), id=p_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAvatarImageByIdError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_avatar_image_by_owner(configuration: &configuration::Configuration, r#type: &str, entity_id: &str, size: Option<&str>, format: Option<&str>) -> Result<(), Error<GetAvatarImageByOwnerError>> {
    ...
    let uri_str = format!("{}/rest/api/3/universal_avatar/view/type/{type}/owner/{entityId}", configuration.base_path, type=crate::apis::urlencode(p_type), entityId=crate::apis::urlencode(p_entity_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAvatarImageByOwnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_avatar_image_by_type(configuration: &configuration::Configuration, r#type: &str, size: Option<&str>, format: Option<&str>) -> Result<(), Error<GetAvatarImageByTypeError>> {
    ...
    let uri_str = format!("{}/rest/api/3/universal_avatar/view/type/{type}", configuration.base_path, type=crate::apis::urlencode(p_type));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetAvatarImageByTypeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_avatars(configuration: &configuration::Configuration, r#type: &str, entity_id: &str) -> Result<models::Avatars, Error<GetAvatarsError>> {
    ...
    let uri_str = format!("{}/rest/api/3/universal_avatar/type/{type}/owner/{entityId}", configuration.base_path, type=crate::apis::urlencode(p_type), entityId=crate::apis::urlencode(p_entity_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::Avatars`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::Avatars`")))),
        }
    } else {
        let content = resp.text().await?;
