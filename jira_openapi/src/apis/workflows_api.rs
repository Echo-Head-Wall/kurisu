...
pub async fn create_workflow(configuration: &configuration::Configuration, create_workflow_details: models::CreateWorkflowDetails) -> Result<models::WorkflowIds, Error<CreateWorkflowError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowIds`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowIds`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn create_workflows(configuration: &configuration::Configuration, workflow_create_request: models::WorkflowCreateRequest) -> Result<models::WorkflowCreateResponse, Error<CreateWorkflowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_workflow_create_request = workflow_create_request;

    let uri_str = format!("{}/rest/api/3/workflows/create", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_workflow_create_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowCreateResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowCreateResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateWorkflowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn delete_inactive_workflow(configuration: &configuration::Configuration, entity_id: &str) -> Result<(), Error<DeleteInactiveWorkflowError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflow/{entityId}", configuration.base_path, entityId=crate::apis::urlencode(p_entity_id));
...
pub async fn get_all_workflows(configuration: &configuration::Configuration, workflow_name: Option<&str>) -> Result<Vec<models::DeprecatedWorkflow>, Error<GetAllWorkflowsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::DeprecatedWorkflow&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::DeprecatedWorkflow&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_project_usages_for_workflow(configuration: &configuration::Configuration, workflow_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::WorkflowProjectUsageDto, Error<GetProjectUsagesForWorkflowError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflow/{workflowId}/projectUsages", configuration.base_path, workflowId=crate::apis::urlencode(p_workflow_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowProjectUsageDto`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowProjectUsageDto`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetProjectUsagesForWorkflowError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_workflow_project_issue_type_usages(configuration: &configuration::Configuration, workflow_id: &str, project_id: i64, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::WorkflowProjectIssueTypeUsageDto, Error<GetWorkflowProjectIssueTypeUsagesError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflow/{workflowId}/project/{projectId}/issueTypeUsages", configuration.base_path, workflowId=crate::apis::urlencode(p_workflow_id), projectId=p_project_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowProjectIssueTypeUsageDto`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowProjectIssueTypeUsageDto`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetWorkflowProjectIssueTypeUsagesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_workflow_scheme_usages_for_workflow(configuration: &configuration::Configuration, workflow_id: &str, next_page_token: Option<&str>, max_results: Option<i32>) -> Result<models::WorkflowSchemeUsageDto, Error<GetWorkflowSchemeUsagesForWorkflowError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflow/{workflowId}/workflowSchemes", configuration.base_path, workflowId=crate::apis::urlencode(p_workflow_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowSchemeUsageDto`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowSchemeUsageDto`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetWorkflowSchemeUsagesForWorkflowError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_workflows_paginated(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, workflow_name: Option<Vec<String>>, expand: Option<&str>, query_string: Option<&str>, order_by: Option<&str>, is_active: Option<bool>) -> Result<models::PageBeanWorkflow, Error<GetWorkflowsPaginatedError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PageBeanWorkflow`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PageBeanWorkflow`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn read_workflows(configuration: &configuration::Configuration, workflow_read_request: models::WorkflowReadRequest, expand: Option<&str>, use_approval_configuration: Option<bool>) -> Result<models::WorkflowReadResponse, Error<ReadWorkflowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_workflow_read_request = workflow_read_request;
    let p_expand = expand;
    let p_use_approval_configuration = use_approval_configuration;

    let uri_str = format!("{}/rest/api/3/workflows", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

    if let Some(ref param_value) = p_expand {
        req_builder = req_builder.query(&[("expand", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_use_approval_configuration {
        req_builder = req_builder.query(&[("useApprovalConfiguration", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    req_builder = req_builder.json(&p_workflow_read_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowReadResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowReadResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ReadWorkflowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn search_workflows(configuration: &configuration::Configuration, start_at: Option<i64>, max_results: Option<i32>, expand: Option<&str>, query_string: Option<&str>, order_by: Option<&str>, scope: Option<&str>, is_active: Option<bool>) -> Result<models::WorkflowSearchResponse, Error<SearchWorkflowsError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflows/search", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowSearchResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowSearchResponse`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn update_workflows(configuration: &configuration::Configuration, workflow_update_request: models::WorkflowUpdateRequest, expand: Option<&str>) -> Result<models::WorkflowUpdateResponse, Error<UpdateWorkflowsError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflows/update", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowUpdateResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowUpdateResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<UpdateWorkflowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn validate_create_workflows(configuration: &configuration::Configuration, workflow_create_validate_request: models::WorkflowCreateValidateRequest) -> Result<models::WorkflowValidationErrorList, Error<ValidateCreateWorkflowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_workflow_create_validate_request = workflow_create_validate_request;

    let uri_str = format!("{}/rest/api/3/workflows/create/validation", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_workflow_create_validate_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowValidationErrorList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowValidationErrorList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ValidateCreateWorkflowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn validate_update_workflows(configuration: &configuration::Configuration, workflow_update_validate_request_bean: models::WorkflowUpdateValidateRequestBean) -> Result<models::WorkflowValidationErrorList, Error<ValidateUpdateWorkflowsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_workflow_update_validate_request_bean = workflow_update_validate_request_bean;

    let uri_str = format!("{}/rest/api/3/workflows/update/validation", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_workflow_update_validate_request_bean);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ValidateUpdateWorkflowsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn workflow_capabilities(configuration: &configuration::Configuration, workflow_id: Option<&str>, project_id: Option<&str>, issue_type_id: Option<&str>) -> Result<models::WorkflowCapabilities, Error<WorkflowCapabilitiesError>> {
    ...
    let uri_str = format!("{}/rest/api/3/workflows/capabilities", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WorkflowCapabilities`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WorkflowCapabilities`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<WorkflowCapabilitiesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
